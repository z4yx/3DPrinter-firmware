...
#define X_PULSES_PER_CYCLE   (8*200)
//X轴运行方向调整(取值+/-1)
...
#define Y_PULSES_PER_CYCLE (8*200)
//Y轴运行方向调整(取值+/-1)
...
#define Z_PULSES_PER_CYCLE (8*200)
//Z轴运行方向调整(取值+/-1)
...
//挤出量系数调整(越大量越少)
#define EXTRUDER_VOLUME_ADJ 12

//挤出器输出更新频率限制(ms)
#define EXTRUDER_UPDATE_PERIOD 500
//挤出器默认温度
#define EXTRUDER_DEFAULT_TEMP 250
//挤出器温度PID控制参数
...
//加热板默认温度
#define HEATBED_DEFAULT_TEMP 93
//加热板传感器值与温度换算
